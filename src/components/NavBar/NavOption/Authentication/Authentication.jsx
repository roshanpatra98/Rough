...
import RecruiterRegister_module from './RecruiterRegister_module';
import ApplicantRegister_module from './ApplicantRegister_module';
    ...
    <>
        ...
        <Modal open={open} onClose={handleClose} aria-labelledby='modal-modal-title' aria-describedby='modal-modal-description'>
            <Box sx={style}>
                ...
                <div marginTop='30px'>
                    <img src={Logo_Dark} alt='Job Streamers' height='90' marg/>
                </div>
                </Grid>
                {
                    authSwitch ? 
                    ...
                    <Grid align='center'>
                        <Button style={{backgroundColor:'#ffeb3b', fontSize:'20px'}} variant='contained' type='submit' sx={{m:1, width:'25ch'}}>
                            Register
                        </Button>
                    </Grid>
                ...
                <Grid align='center' marginTop={5} backgroundColor={'#006379'} color={'#FFFFFF'} height={95} position='absolute' bottom={0} right={0} left={0}>
